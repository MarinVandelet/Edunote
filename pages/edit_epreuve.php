...
<body>
    ...
    <script>
        function updateStudents() {
            ...
            xhr.onload = function () {
                if (xhr.status === 200) {
                    ...
                    updateClassAverage(); // Calcul initial pour la moyenne de classe
                } else {
        ...
        function updateClassAverage() {
            ...
            var moyenneClasse = countNote ? totalNote / countNote : 0;
            ...
            moyenneCell.textContent = countNote ? moyenneClasse.toFixed(2) : "Entrez les notes pour obtenir la moyenne";
        }

        document.getElementById('id_classe').addEventListener('change', updateStudents);
        updateStudents(); // Charger les élèves au chargement initial de la page
    </script>
</body>
</html>
